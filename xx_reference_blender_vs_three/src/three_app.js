...
function set_obj_color(anim_obj,target_coeffs){
	...
	obj.children[0].material.color = sum_Color;
...
function animate() {
    ...
    //log_text(`world pos cam = (${cam_pos.x.toString('.2d')},${cam_pos.y.toString('.2d')},${cam_pos.z.toString('.2d')})`);
    log_text(`world pos cam = (${cam_pos.x.toFixed(2)} ,${cam_pos.y.toFixed(2)} ,${cam_pos.z.toFixed(2)} )`);
}
